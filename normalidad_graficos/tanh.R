...
## tanh:
name = "tanh_2"
all_data = get_data(paste(name,".csv",sep=""),"ANN - 2 capas ocultas. Activación: tanh.")
...
ggsave("2_medianas_diferenciasann_2_capas_ocultas_tanh.png",width = 25, height = 15, units = "cm",dpi = 300)
...
p <- ggplot(all_data) + 
  ...
  theme(plot.subtitle = element_text(family = "Roboto", color="#666666", size=11)) +
  theme(legend.position="bottom")
ggsave("3_accuracy_ann_2_capas_ocultas_tanh.png",width = 25, height = 15, units = "cm",dpi = 300)
...
p <- ggplot(all_data) + 
  ...
  theme(plot.subtitle = element_text(family = "Roboto", color="#666666", size=11)) +
  theme(legend.position="bottom")
ggsave("4_porcentaje_maquinas_mejores_ann_2_capas_ocultas_tanh.png",width = 25, height = 15, units = "cm",dpi = 300)
...
p <- ggplot(all_data) + 
  ...
  theme(plot.subtitle = element_text(family = "Roboto", color="#666666", size=11)) +
  theme(legend.position="bottom")
ggsave("6_error_relativo_ann_2_capas_ocultas_tanh.png",width = 25, height = 15, units = "cm",dpi = 300)
