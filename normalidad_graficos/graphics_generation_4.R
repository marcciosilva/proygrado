...
create_graphics("relu_4.csv","512x16","ANN - 4 capas ocultas. Activación: relu","ann_4_capas_ocultas_relu")

create_graphics("relu_3.csv","512x16","ANN - 3 capas ocultas. Activación: relu","ann_3_capas_ocultas_relu")c

create_graphics("relu_2.csv","512x16","ANN - 2 capas ocultas. Activación: relu","ann_2_capas_ocultas_relu")
...
ann_identity_2 = create_data_frame("identity_2.csv")
ann_identity_2 = add_ranges_to_data(ann_identity_2,4,"ANN - 2 capas ocultas. Activación: identity")
ann_relu_2 = create_data_frame("relu_2.csv")
ann_relu_2 = add_ranges_to_data(ann_relu_2,4,"ANN - 2 capas ocultas. Activación: relu")
svm512 = create_data_frame("512x16-svm.csv")
svm512 = add_ranges_to_data(svm512,4,"SVM")
all_data = rbind(ann_tanh_2,ann_identity_2,ann_relu_2,svm512)
